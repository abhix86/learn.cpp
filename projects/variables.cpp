...
int main() {
    ...
    if(std::cin.fail()) {
        std::cout << "Check your Fu**ing value, you dumb fuck" << std::endl; // hehee 
        exit(1);
    }
    ...
    */
    ...
    // Outputs the result with fixed format and 2 decimal places
    ...
    int a = monthlyInvestment * months; // to get the total invested amount
    int b = sip - a; // to get the total returns

    // Output the total invested amount and estimated returns in lakhs
